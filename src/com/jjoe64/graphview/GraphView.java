...
abstract public class GraphView extends LinearLayout {
	...
	private boolean centerZero = false;
	...
	/**
	 * set's the flag to control if zero should be the center of the Y-Axis
	 * 
	 * @param c
	 * 			true if zero should be centered
	 */
	public void setCenterZero(boolean c) {
		centerZero = c;
	}
}
